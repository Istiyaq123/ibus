...
function LeytonstoneStnGroveGreenRoad(){
    topTextYes.style.display ="block";
    topTextNo.style.display ="none";
    topTextYes.innerHTML = "Leytonstone Stn / Grove Green Road";
...
function StratfordInternationalStationAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_STRATFORD_INTERNATIONAL_STATON_001.mp3";
    iBusAudio.play();
}
...
function StratfordCityBusStationAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_STRATFORD_CITY_BUS_STATION_001.mp3";
    iBusAudio.play();
}
...
function LondonAquaticsCentreAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_LONDON_AQUATICS_CENTRE_001.mp3";
    iBusAudio.play();
}
...
function RothburyRoad(){
    topTextNo.style.display ="none";
    topTextYes.style.display ="block";
    topTextYes.innerHTML = "Rothbury Road";
    topTextYes.style.animationName = "RothburyRoad";
}
function RothburyRoadAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_ROTHBURY_ROAD.mp3";
    iBusAudio.play();
}
function MonierRoad(){
    topTextYes.style.display ="none";
...
function MonierRoadAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_MONIER_ROAD_001.mp3";
    iBusAudio.play();
}
function FishIsland(){
    topTextYes.style.display ="none";
...
function WansbeckRoadAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_WANSBECK_ROAD_001.mp3";
    iBusAudio.play();
}
...
function BarnbyStreetAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_BARMBY_STREET_001.mp3";
    iBusAudio.play();
}
...
function ChurchStreetAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_CHURCH_STREET_001.mp3";
    iBusAudio.play();
}
...
function HermitRoadAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_HERMITE_ROAD_001.mp3";
    iBusAudio.play();
}
...
function CanningTownStationAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_CANNING_TOWN_STATION_001.mp3";
    iBusAudio.play();
}
...
function LadysmithRoadAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_LADYSMITH_ROAD_001.mp3";
    iBusAudio.play();
}
...
function PaulStreetAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_PAUL_STREET_001.mp3";
    iBusAudio.play();
}
...
function StratfordBroadwayAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_STRATFORD_BROADWAY_001.mp3";
    iBusAudio.play();
}
...
function StratfordBusStationAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_STRATFORD_BUS_STATION_001.mp3";
    iBusAudio.play();
}
function TheGrove(){
    topTextYes.style.display ="none";
...
function BrunswickRoadAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_BRUNSWICK_ROAD_001.mp3";
    iBusAudio.play();
}
...
function WansteadHighStWansteadStationAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_WANSTEAD_HIGH_STREET_WANSTEAD_STATION_001.mp3";
    iBusAudio.play();
}
...
function WansteadStationGeorgeGreenAudio(){
    iBusAudio.src="https://transportforlondon.sharepoint.com/sites/ic-68268-j1v9/Ibus/Audio%20announcements/IBus%20Announcements/S_WANSTEAD_STATION_GEORGE_GREEN_001.mp3";
    iBusAudio.play();
}
