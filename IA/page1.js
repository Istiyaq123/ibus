...
function ibus702MileEnd(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "7"+smallSpace+"0"+smallSpace+"2"+bigSpace+"t"+smallSpace+"o"+bigSpace+"M"+smallSpace+"i"+smallSpace+"l"+smallSpace+"e"+bigSpace+"E"+smallSpace+"n"+smallSpace+"d";
  NextDestination.setAttribute( "onClick", "PeelGrove702();" );
}
function PeelGrove702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "P"+smallSpace+"e"+smallSpace+"e"+bigSpace+"l"+bigSpace+"G"+smallSpace+"r"+smallSpace+"o"+smallSpace+"v"+smallSpace+"e";
  BackDestination.setAttribute( "onClick", "ibus702MileEnd();" );
  NextDestination.setAttribute( "onClick", "BonnerStreet702();" );
}
function BonnerStreet702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "B"+smallSpace+"o"+smallSpace+"n"+smallSpace+"n"+smallSpace+"e"+smallSpace+"r"+bigSpace+"S"+smallSpace+"t"+smallSpace+"r"+smallSpace+"e"+smallSpace+"e"+smallSpace+"t";
  BackDestination.setAttribute( "onClick", "PeelGrove702();" );
  NextDestination.setAttribute( "onClick", "SmartStreet702();" );
}
function SmartStreet702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "S"+sSpace+"m"+sSpace+"a"+sSpace+"r"+sSpace+"t"+bSpace+"S"+sSpace+"t"+sSpace+"r"+sSpace+"e"+sSpace+"e"+sSpace+"t";
  BackDestination.setAttribute( "onClick", "BonnerStreet702();" );
  NextDestination.setAttribute( "onClick", "RomanRoadRoveRoad702();" );
}
function RomanRoadRoveRoad702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "R"+sSpace+"o"+sSpace+"m"+sSpace+"a"+sSpace+"n"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d"+bSpace+"/"+bSpace+"G"+sSpace+"r"+sSpace+"o"+sSpace+"v"+sSpace+"e"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "SmartStreet702();" );
  NextDestination.setAttribute( "onClick", "MedwayRoad702();" );
}
function MedwayRoad702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "M"+sSpace+"e"+sSpace+"d"+sSpace+"w"+sSpace+"a"+sSpace+"y"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "RomanRoadRoveRoad702();" );
  NextDestination.setAttribute( "onClick", "FordRoad702();" );
}
function FordRoad702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "F"+sSpace+"o"+sSpace+"r"+sSpace+"d"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "MedwayRoad702();" );
  NextDestination.setAttribute( "onClick", "AliceLane702();" );
}
function AliceLane702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "A"+sSpace+"l"+sSpace+"i"+sSpace+"c"+sSpace+"e"+bSpace+"L"+sSpace+"a"+sSpace+"n"+sSpace+"e";
  BackDestination.setAttribute( "onClick", "FordRoad702();" );
  NextDestination.setAttribute( "onClick", "ParnellRoad702();" );
}
function ParnellRoad702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "P"+sSpace+"a"+sSpace+"r"+sSpace+"n"+sSpace+"e"+sSpace+"l"+sSpace+"l"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "AliceLane702();" );
  NextDestination.setAttribute( "onClick", "RomanRoadMarket702();" );
}
function RomanRoadMarket702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "R"+sSpace+"o"+sSpace+"m"+sSpace+"a"+sSpace+"n"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d"+bSpace+"M"+sSpace+"a"+sSpace+"r"+sSpace+"k"+sSpace+"e"+sSpace+"t";
  BackDestination.setAttribute( "onClick", "ParnellRoad702();" );
  NextDestination.setAttribute( "onClick", "TredegarRoad702();" );
}
function TredegarRoad702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "T"+sSpace+"r"+sSpace+"e"+sSpace+"d"+sSpace+"e"+sSpace+"g"+sSpace+"a"+sSpace+"r"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "RomanRoadMarket702();" );
  NextDestination.setAttribute( "onClick", "BowBusGarage702();" );
}
function BowBusGarage702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "B"+sSpace+"o"+sSpace+"w"+bSpace+"B"+sSpace+"u"+sSpace+"s"+bSpace+"G"+sSpace+"a"+sSpace+"r"+sSpace+"a"+sSpace+"g"+sSpace+"e";
  BackDestination.setAttribute( "onClick", "TredegarRoad702();" );
  NextDestination.setAttribute( "onClick", "BowChurch702();" );
}
function BowChurch702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "B"+sSpace+"o"+sSpace+"w"+bSpace+"C"+sSpace+"h"+sSpace+"u"+sSpace+"r"+sSpace+"c"+sSpace+"h";
  BackDestination.setAttribute( "onClick", "BowBusGarage702();" );
  NextDestination.setAttribute( "onClick", "BowChurchStation702();" );
}
function BowChurchStation702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "B"+sSpace+"o"+sSpace+"w"+bSpace+"C"+sSpace+"h"+sSpace+"u"+sSpace+"r"+sSpace+"c"+sSpace+"h"+bSpace+"S"+sSpace+"t"+sSpace+"a"+sSpace+"t"+sSpace+"i"+sSpace+"o"+sSpace+"n";
  BackDestination.setAttribute( "onClick", "BowChurch702();" );
  NextDestination.setAttribute( "onClick", "BowRoadStation702();" );
}
function BowRoadStation702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "B"+sSpace+"o"+sSpace+"w"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d"+bSpace+"S"+sSpace+"t"+sSpace+"a"+sSpace+"t"+sSpace+"i"+sSpace+"o"+sSpace+"n";
  BackDestination.setAttribute( "onClick", "BowChurchStation702();" );
  NextDestination.setAttribute( "onClick", "CobornRoad702();" );
}
function CobornRoad702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "C"+sSpace+"o"+sSpace+"b"+sSpace+"o"+sSpace+"r"+sSpace+"n"+bSpace+"R"+sSpace+"o"+sSpace+"a"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "BowRoadStation702();" );
  NextDestination.setAttribute( "onClick", "MileEnd702();" );
}
function MileEnd702(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "M"+sSpace+"i"+sSpace+"l"+sSpace+"e"+bSpace+"E"+sSpace+"n"+sSpace+"d";
  BackDestination.setAttribute( "onClick", "CobornRoad702();" );
  NextDestination.setAttribute( "onClick", "BusTerminatesHere702();" );
}
function BusTerminatesHere702(){
  topTextYes.style.display ="Block";
  topTextNo.style.display ="none";
...
function ibusD11TrafalgarSquare(){
  topTextYes.style.display ="block";
  topTextNo.style.display ="none";
  topTextYes.innerHTML = "D11 to Charing Cross Station, Trafalgar Sqaure";
  NextDestination.setAttribute( "onClick", "ChurchhillPlaceD11();" );
  topTextYes.style.animationName = "TrafalgarSquareD11";
}
...
function CanningTownBusStationD11(){
  ...
  NextDestination.setAttribute( "onClick", "AbbottRoadD11();" );
}
function AbbottRoadD11(){
  ...
  topTextNo.innerHTML = "Abbott Road";
  BackDestination.setAttribute( "onClick", "CanningTownBusStationD11();" );
  NextDestination.setAttribute( "onClick", "AberfeldyStreetD11();" );
}
function AberfeldyStreetD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Aberfeldy Street";
  BackDestination.setAttribute( "onClick", "AbbottRoadD11();" );
  NextDestination.setAttribute( "onClick", "EttrickStreetD11();" );
}
function EastIndiaDockRoadD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "East India Dock Road";
  BackDestination.setAttribute( "onClick", "StephensonStreetD11();" );
  NextDestination.setAttribute( "onClick", "GoodwayGardensD11();" );
}
function GoodwayGardensD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Goodway Gardens";
  BackDestination.setAttribute( "onClick", "EastIndiaDockRoadD11();" );
  NextDestination.setAttribute( "onClick", "EttrickStreetD11();" );
}
function EttrickStreetD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Ettrick Street";
  BackDestination.setAttribute( "onClick", "GoodwayGardensD11();" );
  NextDestination.setAttribute( "onClick", "LevenRoadD11();" );
}
function LevenRoadD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Leven Road";
  BackDestination.setAttribute( "onClick", "EttrickStreetD11();" );
  NextDestination.setAttribute( "onClick", "PoplarBaptistChurchD11();" );
}
function PoplarBaptistChurchD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Poplar Baptist Church";
  BackDestination.setAttribute( "onClick", "LevenRoadD11();" );
  NextDestination.setAttribute( "onClick", "TeviotEstateD11();" );
}
function TeviotEstateD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Teviot Estate";
  BackDestination.setAttribute( "onClick", "PoplarBaptistChurchD11();" );
  NextDestination.setAttribute( "onClick", "StMichaelsCourtD11();" );
}
function StMichaelsCourtD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "St Michael's Court";
  BackDestination.setAttribute( "onClick", "TeviotEstateD11();" );
  NextDestination.setAttribute( "onClick", "GlenkerryHouseD11();" );
}
function GlenkerryHouseD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Glenkerry House";
  BackDestination.setAttribute( "onClick", "StMichaelsCourtD11();" );
  NextDestination.setAttribute( "onClick", "HayCurrieStreetD11();" );
}
function JollysGreenD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Jolly's Green";
  BackDestination.setAttribute( "onClick", "StMichaelsCourtD11();" );
...
function HayCurrieStreetD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Hay Currie Street";
  BackDestination.setAttribute( "onClick", "JollysGreenD11();" );
...
function ChrispStreetMarketD11(){
  ...
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Chrisp Street Market";
  BackDestination.setAttribute( "onClick", "HayCurrieStreetD11();" );
...
function BurdettRoadStPaulsChurchD11(){
  ...
  NextDestination.setAttribute( "onClick", "CopperfieldRoadD11();" );
}
function CopperfieldRoadD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Copperfield Road";
  BackDestination.setAttribute( "onClick", "BurdettRoadStPaulsChurchD11();" );
  NextDestination.setAttribute( "onClick", "HarfordStreetD11();" );
}
function HarfordStreetD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Harford Street";
  BackDestination.setAttribute( "onClick", "CopperfieldRoadD11();" );
  NextDestination.setAttribute( "onClick", "StepneyGreenSchoolD11();" );
}
function StepneyGreenSchoolD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Stepney Green School";
  BackDestination.setAttribute( "onClick", "HarfordStreetD11();" );
  NextDestination.setAttribute( "onClick", "MileEndRoadD11();" );
}
function MileEndRoadD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Mile End Road";
  BackDestination.setAttribute( "onClick", "StepneyGreenSchoolD11();" );
...
function StepneyGreenStationD11(){
  ...
  topTextNo.style.display ="block";
  topTextNo.innerHTML = "Stepney Green Station";
  BackDestination.setAttribute( "onClick", "MileEndRoadD11();" );
...
function AldgateEastStationD11(){
  ...
  NextDestination.setAttribute( "onClick", "AldgateStationD11();" );
}
function AldgateStationD11(){
  topTextYes.style.display ="none";
  topTextNo.style.display ="block";
...
function FenchurchStreetD11(){
  ...
  BackDestination.setAttribute( "onClick", "AldgateStationD11();" );
